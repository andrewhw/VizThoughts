...
\begin{minipage}{0.75\textwidth}
\visible<2->{\Large Colour is a stronger channel --- for those who can perceive it
\key{\faThumbsDown}}

\visible<2->{\Large Transparency not as powerful here}
\end{minipage}
\end{textblock*}
\end{frame}
...
\end{minipage}&
\begin{minipage}{0.5\textwidth}
\includegraphics[width=\textwidth]{code/anscombe-lineplot-withmarkers-despine}
\end{minipage}\\
\begin{minipage}{0.5\textwidth}
\includegraphics[width=\textwidth]{code/anscombe-lineplot-scatter-despine}
\end{minipage}&
\begin{minipage}{0.5\textwidth}
\begin{itemize}
