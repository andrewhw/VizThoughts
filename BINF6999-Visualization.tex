...
\end{minipage}
\end{textblock*}
\begin{textblock*}{5in}(1.5in,0.5in)
\begin{minipage}{0.75\textwidth}
\visible<2->{\Large Palette advice:\\ \url{https://jfly.uni-koeln.de/color/}}
\end{minipage}
\end{textblock*}
\end{frame}
...
\begin{tabular}{c}
\\
\includegraphics[width=0.75\textwidth]{code/anscombe-lineplot-scatter}
\end{tabular}
\begin{itemize}
...
\begin{tabular}{c}
\\
\includegraphics[width=0.75\textwidth]{code/anscombe-lineplot-scatter-despine}
\end{tabular}
\begin{itemize}
\item but is this true when nothing is close to the plot?
\end{itemize}
...
\end{minipage}\\[0.5em]
\multicolumn{3}{@{}c}{\begin{minipage}{\textwidth}
\pause
\begin{block}{N.B.}
...
\includegraphics[width=\textwidth]{figures/Ware-Overload}
\end{minipage}&
\multicolumn{2}{c}{\begin{minipage}{0.7\textwidth}
~\\ %\vspace{0.25em}\\
``There are three green squares in this pattern.  The green squares do not show a pop-out effect, even though you know what to look for.
The problem is that your visual cortex can either be tuned for the square shapes or the green things, but not both''\footnotemark[3]
\end{minipage}}
\end{tabular}
\footnotetext[2]{\textcolor{darkgrey}{Ware (2008): {\it Visual Thinking for Design}}}
\footnotetext[3]{\textcolor{darkgrey}{Ware (2008): {\it Visual Thinking for Design, pp.~30.}}}
\end{frame}
